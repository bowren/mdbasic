...
DISK"S0:MYPRG"            :' ERASE FILE MYPRG ON DEVICE 8, DRIVE 0
...
37 DUMP"HELLO THERE"      :' PRINT EXPRESSION TO PRINTER
...
70 I = INSTR(A$,".")      :' GET INDEX OF THE PERIOD IN STR, 0 IF MISSING
...
99 RUN@"PROG2",8          :' LOAD AND RUN ANOTHER PROGRAM WITH MINIMAL SYS INIT
