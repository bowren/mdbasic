...
82 LINE INPUT A$          :REM TAKE INPUT FROM KEYBOARD TILL ENTER KEY PRESSED
83 LINE INPUT#1,A$        :REM READ LINE FROM FILE 1 TERMINATED BY CR
